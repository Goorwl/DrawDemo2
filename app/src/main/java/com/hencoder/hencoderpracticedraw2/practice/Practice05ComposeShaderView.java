...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        BitmapShader bitmapShader1 = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo), Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);

        mComposeShader = new ComposeShader(bitmapShader,bitmapShader1, PorterDuff.Mode.DST_IN);
    }
